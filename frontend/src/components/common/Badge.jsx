...
export const Badge = ({
  ...
  const variants = {
    ...
    primary: 'bg-brand-500/10 text-brand-300 border border-brand-500/30',
    cyber: 'bg-cyber-500/10 text-cyber-300 border border-cyber-500/30 shadow-sm',
    ...
    glow: 'bg-gradient-to-r from-brand-500/15 via-purple-500/15 to-cyber-500/15 text-white border border-brand-400/40 shadow-glow-sm',
  };
