...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-slate-200 dark:border-white/[0.08] bg-slate-100/90 dark:bg-navy-950 text-slate-600 dark:text-slate-400 relative overflow-hidden transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-8 pb-12 border-b border-slate-200 dark:border-white/[0.06]">
          {/* Brand Col (2 spans) */}
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-8 h-8 rounded-lg bg-white dark:bg-white/[0.04] border border-slate-300 dark:border-white/[0.06] flex items-center justify-center text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-white/[0.08] transition-colors"
                aria-label="GitHub"
              >
            ...
            <ul className="space-y-2 text-xs">
              {legalLinks.map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.path}
                    className="hover:text-brand-600 dark:hover:text-slate-300 transition-colors"
                  >
                    {item.name}
                  </Link>
                </li>
            ...
            <form onSubmit={handleSubscribe} className="space-y-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 text-xs rounded-xl bg-white dark:bg-navy-900 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-500"
                />
              </div>
              <button
                type="submit"
                className="w-full py-2 px-3 rounded-xl text-xs font-semibold bg-brand-600 hover:bg-brand-500 text-white flex items-center justify-center gap-1.5 transition-colors shadow-md shadow-brand-500/20"
              >
                {subscribed ? (
                  <>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="flex items-center gap-6">
            <Link to="/privacy" className="hover:text-brand-600 dark:hover:text-slate-300 transition-colors">
              Privacy Policy
            </Link>
            <Link to="/terms" className="hover:text-brand-600 dark:hover:text-slate-300 transition-colors">
              Terms of Service
            </Link>
            <Link to="/cookies" className="hover:text-brand-600 dark:hover:text-slate-300 transition-colors">
              Cookie Preferences
            </Link>
          </div>
        </div>
